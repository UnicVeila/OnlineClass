...
public class SyncTechActivity extends BaseActivity implements OnClickListener {
	...
	private void initView() {
		adapter = new SyncTechFragmentAdapter(getSupportFragmentManager(), this);
